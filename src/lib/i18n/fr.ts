...
export const fr: Dict = {
  ...
  map: {
    ...
    title: "Carte interactive de St Barth — Plages, restaurants & commerces",
    text: "Explorez l'île depuis le confort de la Villa ONLY VIEW.",
    intro:
      "La Villa ONLY VIEW se trouve au cœur de Pointe Milou, l'un des quartiers les plus centraux de Saint-Barth. Depuis votre terrasse, toute l'île est à portée de main. Utilisez la carte pour découvrir 15 plages, les meilleurs restaurants, supermarchés, boulangeries et pharmacies. Chaque repère indique le temps de trajet depuis la villa et trace l'itinéraire — par les bons embranchements, car les routes de St Barth suivent rarement la ligne droite — pour planifier votre journée parfaite : croissants du matin chez Petite Colombe, snorkeling à Colombier, courses au Super U, cocktails au coucher du soleil à Shell Beach et dîner à Gustavia.",
    all: "Tout",
    villa: "Villa ONLY VIEW",
    search: "Rechercher un lieu…",
    noResults: "Aucun résultat",
    fromVilla: "depuis la villa",
    min: "min",
    route: "Itinéraire",
    ...
    website: "Site web",
    call: "Appeler",
    directory: "Tout ce qui figure sur la carte",
    directoryIntro:
      "Les mêmes lieux en texte, avec le temps de trajet depuis la villa — touchez-en un pour le voir sur la carte.",
    beachesTitle: "Les 15 plages de Saint-Barth",
    beachesByUse: "Les plages selon vos envies",
    beachUses: [
    ...
    gettingAroundText:
      "Saint-Barth fait 25 km², avec une route principale qui relie Gustavia, St-Jean, Lorient et Grand Cul-de-Sac ; rien n'est à plus de 20 minutes de la villa. Louez une petite voiture ou une Mini Moke — la conciergerie la fait livrer à la villa — et méfiez-vous des routes étroites et pentues : certaines plages (Colombier, Anse des Cayes) se rejoignent à pied depuis un parking, ce que les itinéraires montrent en pointillés.",
    ctaTitle: "Planifiez vos journées à St Barth",
    ctaText:
      "La conciergerie organise tout — pique-niques sur la plage, réservations de restaurants, journées en bateau, sports nautiques. Le tout à quelques minutes de la Villa ONLY VIEW.",
    ctaButton: "Contacter la conciergerie",
    noscript: "JavaScript est nécessaire pour afficher la carte interactive ; la liste des lieux ci-dessous fonctionne sans.",
  },
  cta: {
