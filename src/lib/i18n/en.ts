export const en = {
  ...
  map: {
    ...
    title: "St Barth Interactive Map — Beaches, Restaurants & Shops",
    text: "Explore the island from the comfort of Villa ONLY VIEW.",
    intro:
      "Villa ONLY VIEW sits in the heart of Pointe Milou, one of St Barth's most central neighbourhoods. From your terrace, the entire island is within easy reach. Use the map to explore 15 beaches, the best restaurants, supermarkets, bakeries and pharmacies. Every pin shows the drive time from the villa and draws the itinerary — via the right turn-offs, because St Barth's lanes rarely follow the shortest line — so you can plan your perfect day: morning croissants at Petite Colombe, snorkelling at Colombier, groceries at Super U, sunset cocktails at Shell Beach and dinner in Gustavia.",
    all: "All",
    villa: "Villa ONLY VIEW",
    search: "Search a place…",
    noResults: "No results",
    fromVilla: "from the villa",
    min: "min",
    route: "Itinerary",
    routeTo: "Itinerary to",
    ...
    website: "Website",
    call: "Call",
    directory: "Everything on the map",
    directoryIntro:
      "The same places as text, with the drive time from the villa — tap one to see it on the map.",
    beachesTitle: "The 15 beaches of St Barth",
    beachesByUse: "Beaches by what you're after",
    beachUses: [
      ["Best for swimming", "Flamands, Lorient, Gouverneur"],
      ["Best for snorkelling", "Colombier, Marigot"],
      ["Best for water sports", "Grand Cul-de-Sac"],
      ["Best for the sunset", "Shell Beach, Gouverneur"],
      ["Best for seclusion", "Colombier, Petit Cul-de-Sac, Saline"],
      ["Closest to the villa", "Lorient (5 min), St Jean (7 min)"],
    ] as Array<[string, string]>,
    gettingAround: "Getting around the island",
    gettingAroundText:
      "St Barth is 25 km² with one main road looping through Gustavia, St-Jean, Lorient and Grand Cul-de-Sac; nowhere is more than 20 minutes from the villa. Rent a small car or a Mini Moke — the concierge delivers it to the villa — and mind the steep, narrow lanes: some beaches (Colombier, Anse des Cayes) are reached on foot from a car park, which the itineraries show as a dashed line.",
    ctaTitle: "Plan your St Barth days",
    ctaText:
      "The concierge arranges everything — beach picnics, restaurant reservations, boat days, water sports. All within minutes of Villa ONLY VIEW.",
    ctaButton: "Contact the concierge",
    noscript: "JavaScript is required to display the interactive map; the list of places below works without it.",
  },
  cta: {
